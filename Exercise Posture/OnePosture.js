...
// In this code only One Posture Exercise Counter  Works Nothing of model switch.
...
function setup() {
    ...
    const modelInfo2 = {// this is for tree posture.
        model: `Models/model17.json`,
        metadata: `Models/model17_meta.json`,
        weights: `Models/model17.weights.bin`,
    };
